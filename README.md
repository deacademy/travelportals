...
You want to download the source code in your local system through git command then make sure you have git versioning tool installed in your local system.
